...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --arch=arm --enable-nonfree --enable-asm --cpu=cortex-a8 --enable-neon --cc=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --nm=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --sysroot=/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm//usr/lib -L/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog' --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-swscale --disable-swresample --enable-avformat --enable-avcodec --disable-optimizations --disable-debug --disable-doc --disable-stripping --enable-pthreads --disable-yasm --enable-zlib --enable-pic --enable-small
...
ARCH=arm
CC=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CXX=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++
AS=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/home/zhoulc/work/tools/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= --sysroot=/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 -mcpu=cortex-a8 -std=c99 -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 -mcpu=cortex-a8 -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -Wl,-rpath-link=/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm//usr/lib -L/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog  --sysroot=/home/zhoulc/work/tools/android-ndk-r8e/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
