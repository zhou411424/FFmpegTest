...
public class VideoSurfaceView extends GLSurfaceView implements Renderer{
	...
	public void onDrawFrame(GL10 gl) {
		VideoPlayerSurfaceFunction.getAppCameraSurfaceFunctionInstance().VideoPlayerShow_Render();
	}
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		if (isFirstChange) {
			VideoPlayerSurfaceFunction.getAppCameraSurfaceFunctionInstance().VideoPlayerShow_GLInit(width, height);
			isFirstChange = false;
		}
	}
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		VideoPlayerSurfaceFunction.getAppCameraSurfaceFunctionInstance().VideoPlayerShow_GLCreate();
	}
